...
minetest.register_node("default:junglegrass", {
	...
	paramtype = "light",
	walkable = false,
	groups = {snappy=3,flammable=2,attached_node=1,oddly_breakable_by_hand=2},
...
minetest.register_node("default:papyrus", {
	...
	groups = {snappy=3,flammable=2,oddly_breakable_by_hand=1},
	sounds = default.node_sound_leaves_defaults(),
})
...
minetest.register_node("default:dry_shrub", {
	...
	paramtype = "light",
	walkable = false,
	groups = {snappy=3,flammable=3,attached_node=1,oddly_breakable_by_hand=2},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
